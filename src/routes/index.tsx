  ...
  return <div className="min-h-screen overflow-hidden bg-background text-foreground">
    ...
    <main id="top">
      ...
      <section id="features" className="mx-auto max-w-7xl px-5 py-28 lg:px-8">
        <div className="mb-12 max-w-2xl"><span className="text-xs font-medium uppercase tracking-widest text-primary">Infrastructure, evolved</span><h2 className="mt-4 text-3xl font-bold sm:text-5xl">Built on Enterprise-Grade Hardware.</h2><p className="mt-4 text-muted-foreground">A resilient platform engineered for speed, security, and intelligent operations.</p></div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8"><div className="relative overflow-hidden rounded-lg border border-primary/20 bg-primary/10 px-6 py-16 text-center shadow-[var(--shadow-glow)]"><Sparkles className="mx-auto mb-5 size-7 text-primary"/><h2 className="text-3xl font-bold sm:text-5xl">Ready to migrate to OxynHost?</h2><p className="mx-auto mt-4 max-w-xl text-muted-foreground">Move faster on infrastructure built to disappear into the background.</p><Button variant="glow" size="lg" className="mt-8" onClick={() => openOrder("Virtual Servers")}>Get Started Now <ArrowRight /></Button></div></section>
    </main>
